...
export default function MessageScreen() {
  ...
  const baseConversation = useMemo(() => {
    return dummyConversations.find(c => c.id === params.conversationId) || dummyConversations[0];
  ...
  const conversation: ExtendedConversation = useMemo(() => {
    return {
      ...
      members: [
        { id: 'CK', avatar: 'https://api.dicebear.com/7.x/avataaars/png?seed=CK' },
        { id: 'CL', avatar: 'https://api.dicebear.com/7.x/avataaars/png?seed=CL' },
        { id: 'JR', avatar: 'https://api.dicebear.com/7.x/avataaars/png?seed=JR' }
      ]
    };
  }, [baseConversation]);
            ...
            <View style={styles.lyricsContainer}>
              {conversation.currentSong.lyrics.map((line, index) => (
                <Text 
                  ...
                  style={[
                    styles.lyricText, 
                    index === 0 ? styles.firstLyricLine : (index === 1 ? styles.highlightedLyricLine : styles.lastLyricLine)
                  ]}
                >
                  {line}
                </Text>
              ...
              <View style={styles.songInfoContainer}>
                <Text style={styles.songTitle}>{conversation.currentSong.title}</Text>
                <Text style={styles.artistName}>{conversation.currentSong.artist}</Text>
              </View>
            </View>
